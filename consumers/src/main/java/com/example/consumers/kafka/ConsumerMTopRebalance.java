...
public class ConsumerMTopRebalance {
    public static final Logger LOGGER = LoggerFactory.getLogger(ConsumerMTopRebalance.class.getName());
        ...
        try {
            while(true) {
                ...
                for(ConsumerRecord record : consumerRecords) {
                    LOGGER.debug("topice : {}, record key : {}, record value : {}, partition : {}, offset : {}",
